...
{% include image.html alt='Blocksatz' image='progressiver-html-blocksatz-mit-silbentrennung/hyphans-manual.png' width=351 height=221 %}
...
{% include image.html alt='Blocksatz mit Silbentrennung' image='progressiver-html-blocksatz-mit-silbentrennung/hyphans-auto.png' width=351 height=205 %}
